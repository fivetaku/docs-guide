# Disclaimer & Acceptable Use — docs-guide

`docs-guide` is part of the [gptaku-plugins](https://github.com/fivetaku/gptaku_plugins)
...
`docs-guide` is a general-purpose developer tool. Like most general-purpose tools, it
